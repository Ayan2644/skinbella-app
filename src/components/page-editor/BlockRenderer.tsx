  ...
  switch (block_type) {
    ...
    case "image":
      return content.src ? (
        <img
          src={content.src}
          alt={content.alt || "Imagem do resultado"}
          loading="lazy"
      ...
      return (
        <div style={{ textAlign: (st.textAlign || "center") as React.CSSProperties["textAlign"], padding: st.padding }}>
          <Button
            ...
            style={{
              fontSize: st.fontSize as React.CSSProperties["fontSize"],
              borderRadius: st.borderRadius as React.CSSProperties["borderRadius"],
            }}
          >
