...
import { Home, FileText, Droplets, Sun, CheckSquare, Apple, BookOpen, ShoppingBag, HelpCircle, LogOut, Menu, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex flex-col w-56 border-r border-border bg-card/50 p-4">
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">Olá, {auth.name} ✨</p>
        </div>
